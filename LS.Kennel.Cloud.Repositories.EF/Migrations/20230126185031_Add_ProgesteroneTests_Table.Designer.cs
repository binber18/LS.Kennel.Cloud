...
namespace LS.Kennel.Cloud.Repositories.EF.Migrations
{
    ...
    [Migration("20230126185031_Add_ProgesteroneTests_Table")]
    partial class AddProgesteroneTestsTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LS.Kennel.Cloud.Models.KennelOwnership", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("LS.Kennel.Cloud.Models.Heat", b =>
                {
                    b.HasOne("LS.Kennel.Cloud.Models.Dog", "Dog")
                        .WithMany("Heats")
                        .HasForeignKey("DogId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("LS.Kennel.Cloud.Models.KennelOwnership", b =>
                {
                    ...
                    b.HasOne("LS.Kennel.Cloud.Models.AppUser", "User")
                        .WithMany("KennelOwnerships")
